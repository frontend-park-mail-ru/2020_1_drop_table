import './LandingCafeCard.scss';
import './LandingCafeCard.color.scss';
import LandingCafeCard from '../LandingCafeCard/LandingCafeCard.hbs';

/** Компонент карточки кафе */
export class LandingCafeCardComponent {
     ...
     */
    _renderTemplate() {
        this._el.innerHTML = LandingCafeCard({cafeImageSrc:this._imgSrc,name:this._name, id:this._id});
    }
